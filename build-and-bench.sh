...
# 0 18 * * * sudo -E nice --adjustment=-10 env SERVER_BRANCH=8.0 WORKLOAD_NAMES=reads,writes TEMPLATE_PATH=/mnt/fast/template_datadir /mnt/fast/przemek/perf-tests/build-and-bench.sh
#            sudo -E nice --adjustment=-10 bash -c "./run-ACID-shm.sh >run-ACID-shm.txt 2>&1"
#
